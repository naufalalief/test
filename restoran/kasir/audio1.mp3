...
<body>
	<table   width="100%">
		...
		<tr><td colspan="10"><hr><center>Tanda Bukti <s>Ngutang</s> Pembayaran</center><hr>
				<?php
					include 'koneksi.php';
					$query = "SELECT t.id_transaksi, p.id_pesanan, m.nama_menu, p.jumlah, t.total, t.bayar, m.harga FROM transaksi t, pesanan p, menu m WHERE id_transaksi = '".$_GET["id_transaksi"]."' AND t.id_pesanan = p.id_pesanan AND p.id_menu = m.id_menu
";
